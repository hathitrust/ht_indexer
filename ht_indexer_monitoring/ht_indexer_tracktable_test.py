...
from ht_indexer_monitoring.ht_indexer_tracktable import HTIndexerTrackData, HTIndexerTracktable
...
class TestHTIndexerTracktable:
    ...
    def test_insert_batch(self, ht_indexer_tracktable_instance, mock_db_conn):
        ...
        assert mock_db_conn.insert_batch.call_args[0][0].startswith("INSERT INTO ht_indexer_tracktable")
